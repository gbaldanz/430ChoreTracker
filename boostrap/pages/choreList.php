        ...
        <div class="container-fluid">
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="user-info">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="../pages/myFamily.html">
                                <img src="../images/icons/2.png" alt="">
                                <span class="menu-title">My Family</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/rewardList.html">
                                <!-- <i class="fa fa-calculator"></i> -->
                                <img src="../images/icons/4.png" alt="">
                                <span class="menu-title">Reward List</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/addChore.html">
                                <!-- <i class="fa fa-table"></i> -->
                                <img src="../images/icons/5.png" alt="">
                                <span class="menu-title">Add Chore</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/addReward.html">
                                <!-- <i class="fa fa-bar-chart"></i> -->
                                <img src="../images/icons/6.png" alt="">
                                <span class="menu-title">Add Reward</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/createChore.html">
                                <!-- <i class="fa fa-font"></i> -->
                                <img src="../images/icons/7.png" alt="">
                                <span class="menu-title">Create Chore</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/createReward.html">
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Chore List</h3>
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    $username = "gbaldanz";
                                    $password = "CPSC430_Fall17project";
                                    $dbname = "CPSC430_Fall17project1";
                                    ...
                                    if ($result-&gt;num_rows &gt; 0) {
                                        echo "<table class = "table"><thead><tr class="text-success"><th>Name</th><th>Points</th><th>Description</th></tr>";
                                        // output data of each row
                                        while($row = $result-&gt;fetch_assoc()) {
                                            echo "<tr><td>".$row["NAME"]."</td><td>".$row["VALUE"]." ".$row["NOTES"]."</td></tr>";
                                        }
                                        echo "</table>";
                                    } else {
                                        echo "0 results";
